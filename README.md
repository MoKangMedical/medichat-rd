...
💊 MediChat-RD — Multi-agent medical diagnosis platform (rare disease edition). CrewAI + PubMed + OMIM.
...
1. **构建镜像**
```bash
docker build -t medichat-rd .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name medichat-rd medichat-rd
```
...
- **项目主页**: https://github.com/MoKangMedical/medichat-rd
- **问题反馈**: https://github.com/MoKangMedical/medichat-rd/issues
