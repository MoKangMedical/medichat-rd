...
> **红杉核心论点**：下一代万亿美元公司是伪装成服务公司的软件公司。从卖工具到卖结果——大模型进步让服务更快更便宜，利润空间更大。

MediChat-RD不是卖诊断工具，是卖**诊断结果**（症状→确诊报告）。大模型能力在进步，我们的诊断Harness让结果更快更准，利润空间更大。

> 详见 [理论宪法](projects/THEORETICAL_CONSTITUTION.md) 第三卷·价值论
